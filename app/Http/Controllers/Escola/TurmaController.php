...
class TurmaController extends Controller
{
    ...
    {
        $numero = str_pad(mt_rand(0, 99999999), 20, '0', STR_PAD_LEFT);
        try {
            ...
            $escola = Turma::create([
                $escola = Turma::create([
                    ...
                    'grupo_nao_seriado' => $validated['grupo_nao_seriado'] ?? null,
                    ...
                    'materia_outras_unidades_curriculares' => $validated['outras_unidades_curriculares'] ?? null,

                    'classe_bilingue_surdos' => $validated['classe_bilingue_surdos'] ?? null,
    ...
    public function update(UpdateTurmaRequest $request, $id)
    {
        try {
            ...
            $turma->update([
                'tipo_registro' => '20',
                'codigo_escola_inep' => $validated['codigo_escola_inep'],
                'codigo_turma' => $validated["codigo_turma"],
                'codigo_turma_inep' => $validated['codigo_turma_inep'],
                'nome_turma' => $validated['nome_turma'] ?? null,
                'tipo_medicao' => $validated['tipo_medicao'] ?? null,
                'horario_inicio' => $validated['horario_inicio'] ?? null,
    ...
    {
        try {
            $turma = Turma::with(['escola', 'materias'])
                        ->findOrFail($id);
